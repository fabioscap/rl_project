...
def parse_args():
    ...
    parser.add_argument('--obs_shape', default=84, type=int)
    ...
    parser.add_argument('--a_hidden_dims', default=(50,50,), type=tuple)
    parser.add_argument('--a_out_act', default= None)
    parser.add_argument('--fdm_hidden_dims', default=(50,50,), type=tuple)
    parser.add_argument('--fdm_out_act', default=None)
    parser.add_argument('--fdm_lr', default=1e-3, type=float)
    parser.add_argument('--fdm_beta', default=0.9, type=float)
...
def make_agent(obs_shape, action_shape, args, device):
    if args.agent == 'sac_ae':
        return SacAgent(
            ...
            a_dim = args.a_dim,
            a_hidden_dims = args.a_hidden_dims , 
            a_out_act = args.a_out_act ,     
            fdm_hidden_dims = args.fdm_hidden_dims ,
            fdm_out_act = args.fdm_out_act ,  
            fdm_lr = args.fdm_lr,
            fdm_beta = args.fdm_beta,
...
def main():
    ...
    agent = make_agent(
        obs_shape=(env.observation_space.shape[0], args.obs_shape, args.obs_shape),
        action_shape=env.action_space.shape,
        args=args,
        device=device
    )
